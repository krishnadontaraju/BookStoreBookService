...
public class BookServiceExceptionHandler {
	...
	@org.springframework.web.bind.annotation.ExceptionHandler(BookServiceException.class)
    public ResponseEntity<Response> handleInsuranceCategoryException (BookServiceException exception){
